...
#define LVD 11.0          //Low voltage disconnect setting for a 12V system
...
//-------------------------------------------------------------------------------------------------------------
 void read_data(void) 
 {
    ...
    // Vout=Vin*R2/(R1+R2) => Vin = Vout*(R1+R2)/R2   R1=100 and R2=20
     solar_volt = read_adc(SOL_ADC)*0.00488*(101000/19870);
     bat_volt   = read_adc(BAT_ADC)*0.00488*(99700/19870);       
     load_current = (read_adc(CURRENT_ADC)*.0488 -32); 
