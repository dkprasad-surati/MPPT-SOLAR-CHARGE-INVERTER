...
//by deba168,INDIA
//Dated : 22/10/2014
//Updated 29/09/2021___V1.1.2 Library
    ...
    // A2 - ACS712 to monitor load current                   (Inverter)
    // A3 - LM 35 Temperature is connected to pin A3
    // A4 - LCD SDA 
    // A5 - LCD SCL
  
    // D0-  Not used
    // D1-  Not used
    // D2 - Control Load MOSFET Q2          (Inverter Side)
    // D3 - PWM Output to control MOSFET Q1 (charging MOSFET) 
    // D4 - Not Used
...
#define SOL_RED_LED 10       // Please select pin
#define SOL_GREEN_LED 11    // please select pin
//--------------------------------------------------------------------------------------------------------------------------
...
lcd.createChar(4,alarm);   // default in this line disabled 
...
lcd.setCursor(0, 1);                                                                   //  This function is for only Greeting Or Advertising On Display The Incriment use after Load On Delay (Inverter Late On or Start) Not Immedietly Run Ups Type
lcd.clear();                                                                           //#####//------------------@@@@@@@@@@@@@@@@@@@@@@---------------------
delay(5000);                                                                           //#####//-----------------------@@@@@@@@@@@@--------------------------
//############################################################################################//--------------------------@@@@@@-----------------------------
//############################################################################################//----------------------------@@-------------------------------
...
//  digitalWrite(SOL_GREEN_LED,HIGH);
}
//------------------------------------------------------------------------------------------------------
//////////////////////// LCD DISPLAY///////////////////////////////////////////////////////////
//------------------------------------------------------------------------------------------------------
